...
namespace CuttingSystem3mk.Models
{
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                    ...
                    //optionsBuilder.UseSqlServer(@"Server=sql6001.site4now.net;Database=DB_A43487_CuttingSystem3mkDB;MultipleActiveResultSets=true;User Id=DB_A43487_CuttingSystem3mkDB_admin;Password=V@sya123!;");
#else
                optionsBuilder.UseSqlServer(@"Server=sql6001.site4now.net;Database=DB_A43487_CuttingSystem3mkDB;MultipleActiveResultSets=true;User Id=DB_A43487_CuttingSystem3mkDB_admin;Password=V@sya123!;");
#endif
            }
